define({
    ...
    licenseManagerToolTipHelp: '이 워크플로는 라이선스 관리자만 이용 가능합니다. Concurrent License와 Network Named User License를 사용하려면 서버에 네트워크 라이선스 매니저를 설치해야 합니다.',
    akLabel: '활성화 키 입력',
    ...
    documentationInstructionMsg: '<br>설명서는 기본적으로 온라인에서 사용 가능합니다. 오프라인으로 사용하는 경우 로컬 복사본을 설치하십시오.<br><a href="https://www.mathworks.com/pi_doconline_mpi_${0}_${1}" target="_blank">자세히 알아보기</a>',
